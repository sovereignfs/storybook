import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{t as n}from"./iframe-BSD6rMsc.js";import{t as r}from"./jsx-runtime-CaZkqeYb.js";import{n as i,t as a}from"./useSnapCarousel-B8nxsiq2.js";var o,s,c,l,u,d=e((()=>{o=`_dots_j57rp_1`,s=`_dotsCompact_j57rp_14`,c=`_dot_j57rp_1`,l=`_dotActive_j57rp_56`,u={dots:o,dotsCompact:s,dot:c,dotActive:l}}));function f({count:e,activeIndex:t,onJump:n,labels:r,"aria-label":i,density:a=`default`,className:o}){return(0,p.jsx)(`div`,{role:`tablist`,"aria-label":i,className:[u.dots,a===`compact`?u.dotsCompact:``,o].filter(Boolean).join(` `),children:Array.from({length:e},(i,a)=>{let o=a===t;return(0,p.jsx)(`button`,{type:`button`,role:`tab`,"aria-selected":o,"aria-label":r?.[a]??`Slide ${a+1} of ${e}`,className:[u.dot,o?u.dotActive:``].filter(Boolean).join(` `),onClick:()=>n(a)},a)})})}var p,m=e((()=>{d(),p=r(),f.__docgenInfo={description:`SwipableMobileCarouselDots — a real, tappable, labeled slide indicator.
...
consistent with it rather than gold-plating past its sibling.`,methods:[],displayName:`SwipableMobileCarouselDots`,props:{count:{required:!0,tsType:{name:`number`},description:``},activeIndex:{required:!0,tsType:{name:`number`},description:``},onJump:{required:!0,tsType:{name:`signature`,type:`function`,raw:`(index: number) => void`,signature:{arguments:[{type:{name:`number`},name:`index`}],return:{name:`void`}}},description:``},labels:{required:!1,tsType:{name:`Array`,elements:[{name:`unknown`}],raw:`(string | undefined)[]`},description:`Per-dot accessible names, e.g. ["Lists", "Starred", "Groceries"]. Falls
 ...
 SwipableMobileCarousel's own required aria-label).`},density:{required:!1,tsType:{name:`union`,raw:`'default' | 'compact'`,elements:[{name:`literal`,value:`'default'`},{name:`literal`,value:`'compact'`}]},description:"`'compact'` halves the gap between dots (`--sv-space-2` → `--sv-space-1`)\n and shrinks each dot's own hit target (20px → 16px) — for a carousel\n with enough slides that even the reduced gap alone still reads as too\n wide on a narrow viewport (e.g. a many-list mobile app). The visible\n 6px dot itself is unchanged; only its surrounding tap-target box\n shrinks. Defaults to `'default'` — every existing consumer's spacing is\n unaffected unless it opts in.",defaultValue:{value:`'default'`,computed:!1}},className:{required:!1,tsType:{name:`string`},description:``}}}})),h,g,_=e((()=>{h=t(n(),1),g=(0,h.createContext)(null)}));function v({children:e}){return(0,y.useContext)(g)?.isMounted?(0,b.jsx)(b.Fragment,{children:e}):null}var y,b,x=e((()=>{y=t(n(),1),_(),b=r(),v.__docgenInfo={description:`SwipableMobileCarouselSlide — a single slide of a SwipableMobileCarousel.
...
centralized instead of hand-rolled per plugin.`,methods:[],displayName:`SwipableMobileCarouselSlide`,props:{slideKey:{required:!0,tsType:{name:`string`},description:`Stable identity for this slide, independent of its position among
 ...
 available synchronously already.`},children:{required:!0,tsType:{name:`ReactNode`},description:`SwipableMobileCarouselSlideHeader/Body/Footer, in any order/subset.`}}}})),S,C,w,T,E,D=e((()=>{S=`_wrap_toa2s_1`,C=`_scroller_toa2s_7`,w=`_slide_toa2s_27`,T=`_indicatorSlot_toa2s_42`,E={wrap:S,scroller:C,slide:w,indicatorSlot:T}}));function O(e){let t=[];return A.Children.forEach(e,(e,n)=>{if(e==null||e===!1||e===!0||!(0,A.isValidElement)(e)||e.type!==v)return;let r=e.props;t.push({key:r.slideKey,label:r.label,element:e})}),t}function k({activeIndex:e,onSettle:t,prefetchDistance:n=1,settleDebounceMs:r=120,"aria-label":a,renderIndicator:o,className:s,children:c}){let l=(0,A.useMemo)(()=>O(c),[c]),u=l.length,d=u===0?0:Math.max(0,Math.min(u-1,e)),p=(0,A.useRef)(d),{scrollRef:m,scrollToIndex:h,liveIndex:_}=i({itemCount:u,onSettle:t,debounceMs:r,initialIndex:p.current});(0,A.useLayoutEffect)(()=>{h(p.current,`instant`)},[]);let v=(0,A.useRef)(!1);(0,A.useEffect)(()=>{if(!v.current){v.current=!0;return}h(d,`smooth`)},[d,h]);let y=(0,A.useRef)(null);(0,A.useLayoutEffect)(()=>{let e=l.map(e=>e.key),n=y.current;if(n&&!(n.length===e.length&&n.every((t,n)=>t===e[n]))){let r=n[d];if(r!==void 0){let n=e.indexOf(r);n!==-1&&n!==d&&(h(n,`instant`),t(n))}}y.current=e});function b(e){h(e,`smooth`),t(e)}let x=l.map(e=>e.label),S=o===null?null:o?o({count:u,activeIndex:d,labels:x,onJump:b}):(0,j.jsx)(f,{count:u,activeIndex:d,labels:x,"aria-label":a,onJump:b});return(0,j.jsxs)(`div`,{className:[E.wrap,s].filter(Boolean).join(` `),children:[(0,j.jsx)(`div`,{className:E.scroller,ref:m,role:`region`,"aria-label":a,children:l.map((e,t)=>(0,j.jsx)(`div`,{className:E.slide,children:(0,j.jsx)(g.Provider,{value:{isMounted:Math.abs(t-d)<=n||Math.abs(t-_)<=n},children:e.element})},e.key))}),S&&(0,j.jsx)(`div`,{className:E.indicatorSlot,children:S})]})}var A,j,M=e((()=>{A=t(n(),1),a(),m(),x(),_(),D(),j=r(),k.__docgenInfo={description:`SwipableMobileCarousel — a compound component for swiping between full-
...
sovereign-shopper's equivalent, which keeps its overlay in the routed pane.`,methods:[],displayName:`SwipableMobileCarousel`,props:{activeIndex:{required:!0,tsType:{name:`number`},description:`Controlled active slide index — the caller owns this (typically via
 ...
 logged for any other child type — see resolveSlides below.`}}}})),N,P,F,I,L,R=e((()=>{N=`_header_1l8zq_1`,P=`_footer_1l8zq_2`,F=`_body_1l8zq_6`,I=`_loading_1l8zq_22`,L={header:N,footer:P,body:F,loading:I}}));function z({children:e,className:t}){return(0,B.jsx)(`div`,{className:[L.header,t].filter(Boolean).join(` `),children:e})}var B,V=e((()=>{R(),B=r(),z.__docgenInfo={description:`SwipableMobileCarouselSlideHeader — always renders its children, no
...
content is still loading — see that component's doc comment.`,methods:[],displayName:`SwipableMobileCarouselSlideHeader`,props:{children:{required:!0,tsType:{name:`ReactNode`},description:``},className:{required:!1,tsType:{name:`string`},description:``}}}}));function H({children:e,loading:t=!1,loadingFallback:n,className:r}){return(0,U.jsx)(`div`,{className:[L.body,r].filter(Boolean).join(` `),children:t?n??W:e})}var U,W,G=e((()=>{R(),U=r(),W=(0,U.jsx)(`div`,{className:L.loading,children:`Loading…`}),H.__docgenInfo={description:`SwipableMobileCarouselSlideBody — the scrollable region of a slide.
...
horizontal swipe between slides.`,methods:[],displayName:`SwipableMobileCarouselSlideBody`,props:{children:{required:!0,tsType:{name:`ReactNode`},description:``},loading:{required:!1,tsType:{name:`boolean`},description:`While true, renders \`loadingFallback\` INSTEAD OF children — scoped to
 ...
 of gating the entire slide behind one boolean.`,defaultValue:{value:`false`,computed:!1}},loadingFallback:{required:!1,tsType:{name:`ReactNode`},description:``},className:{required:!1,tsType:{name:`string`},description:``}}}}));export{L as a,M as c,f as d,m as f,V as i,v as l,G as n,R as o,z as r,k as s,H as t,x as u};